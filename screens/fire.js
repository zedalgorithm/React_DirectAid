...
export default function UserDashboard() {
  ...
  return (
    ...
    <Text style={{marginLeft:5, color:"#F1811A", fontSize: 20, fontWeight:"bold"}}>Report Fire Emergency</Text>
    </View>
      ...
      {!isFullscreen && (
        <ScrollView style={styles.form}>
          ...
          <View style={styles.row}>
            <TouchableOpacity
              style={[styles.emergencyButton, emergencyType === "Fire" && styles.selectedButton]}
              onPress={() => setEmergencyType("Fire")}
            >
            <MaterialIcons name="local-fire-department" size={40} color="#F1811A" />
              <Text style={[styles.emergencyButtonText,{color:"#F1811A"}]}>Fire</Text>
            </TouchableOpacity>
