...
<View style={{alignSelf: "center", marginTop: 1, flexDirection:"row", alignItems:"center"}}>
    ...
    <Text style={{marginLeft:5, color:"#C82538", fontSize: 20, fontWeight:"bold"}}>REPORT MEDICAL EMERGENCY</Text>
    </View>
      ...
      {!isFullscreen && (
        <ScrollView style={styles.form}>
          ...
          <View style={styles.row}>
            <TouchableOpacity
              style={[styles.emergencyButton, emergencyType === "Vehicular Accident" && styles.selectedButton]}
              onPress={() => setEmergencyType("Vehicular Accident")}
            >
            <FontAwesome5 name="car-crash" size={40} color="#C82538" />
              <Text style={styles.emergencyButtonText}>Vehicular Accident</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.emergencyButton, emergencyType === "Medical Case" && styles.selectedButton]}
              onPress={() => setEmergencyType("Medical Case")}
            >
            <FontAwesome6 name="briefcase-medical" size={40} color="#C82538" />
              <Text style={styles.emergencyButtonText}>Medical Case</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.emergencyButton, emergencyType === "Trauma Case" && styles.selectedButton]}
              onPress={() => setEmergencyType("Trauma Case")}
            >
            <MaterialCommunityIcons name="account-injury" size={40} color="#C82538" />
              <Text style={styles.emergencyButtonText}>Trauma Case</Text>
            </TouchableOpacity>
          </View>
